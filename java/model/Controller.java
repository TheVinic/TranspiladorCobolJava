...
public class Controller {
	...
	public void home(){
		...
		dadosprincipal.setDec1(31 + dadosprincipal.getDec2() + Integer.parseInt(char1.getChar1().toTrancode()) + dadosprincipal.getDec1());
		dadosprincipal.setDec2(31 + dadosprincipal.getDec2() + Integer.parseInt(char1.getChar1().toTrancode()) + dadosprincipal.getDec2());

		System.out.println("CHAR1 = "  + char1.toTrancode());
		System.out.println("CHAR2 = "  + char1.getChar2().toTrancode());
