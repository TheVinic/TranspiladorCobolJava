...
public class Controller {
	...
	public void home(){
		...
		dadosprincipal.setDec1(31 + dadosprincipal.getDec2() + Integer.parseInt(char1.getChar1().toString()) + dadosprincipal.getDec1());
		dadosprincipal.setDec2(31 + dadosprincipal.getDec2() + Integer.parseInt(char1.getChar1().toString()) + dadosprincipal.getDec2());
